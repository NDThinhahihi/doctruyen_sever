...
router.post('/UpdateLogo',uploadLogo.single('LogoUpdate'),comicsController.postUpdateLogoChuaDuyet)
...
router.get('/view/:id',viewChapterController.getViewChapterChuaDuyet);
router.post('/view/:id/add',viewChapterController.postAddChapterChuaDuyet);
router.post('/view/:id/delete',viewChapterController.postDeleteChapterChuaDuyet);
router.post('/view/:id/update',viewChapterController.postUpdateChapterChuaDuyet);
router.post('/view/:id/search',viewChapterController.postSearchChapterChuaDuyet);
